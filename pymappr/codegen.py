...
generation time). The drawing code below replicates PyMappr's own
renderer - same view, layers, draw order, colors, and legend - so the
output matches the map in the app.
